...
public class TestBuilders {
  ...
  public static StoryRecord.Builder testStoryRecordBuilder() {
    return storyRecordBuilder().id(4L).projectId(3L).name("Something Fun");
  }

  public static StoryFields.Builder testStoryFieldsBuilder() {
    return storyFieldsBuilder().projectId(3L).name("Something Fun");
  }

  public static StoryInfo.Builder testStoryInfoBuilder() {
    return storyInfoBuilder().id(4L).projectId(3L).name("Something Fun").info("story info");
  }

  public static StoryForm.Builder testStoryFormBuilder() {
    return storyFormBuilder().projectId(3L).name("Something Fun");
  }
}
