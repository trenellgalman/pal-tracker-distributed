...
public class FlowTest {
  ...
  private ApplicationServer registrationServer =
      new ApplicationServer(
          workingDir + "/../applications/registration-server/build/libs/registration-server.jar",
          "8883");
  private ApplicationServer allocationsServer =
      new ApplicationServer(
          workingDir + "/../applications/allocations-server/build/libs/allocations-server.jar",
          "8881");
  private ApplicationServer backlogServer =
      new ApplicationServer(
          workingDir + "/../applications/backlog-server/build/libs/backlog-server.jar", "8882");
  private ApplicationServer timesheetsServer =
      new ApplicationServer(
          workingDir + "/../applications/timesheets-server/build/libs/timesheets-server.jar",
          "8884");
  ...
  public void testBasicFlow() throws Exception {
    ...
    response =
        httpClient.post(
            registrationServerUrl("/registration"), jsonMapBuilder().put("name", "aUser").build());
    ...
    response =
        httpClient.post(
            registrationServerUrl("/projects"),
            jsonMapBuilder().put("accountId", createdAccountId).put("name", "aProject").build());
    ...
    response =
        httpClient.post(
            allocationsServerUrl("/allocations"),
            jsonMapBuilder()
    ...
    response =
        httpClient.post(
            backlogServerUrl("/stories"),
            jsonMapBuilder().put("projectId", createdProjectId).put("name", "A story").build());
    ...
    response =
        httpClient.post(
            timesheetsServerUrl("/time-entries"),
            jsonMapBuilder()
                .put("projectId", createdProjectId)
                .put("userId", createdUserId)
                .put("date", "2015-12-17")
